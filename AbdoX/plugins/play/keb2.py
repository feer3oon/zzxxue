...
OWNER_ID = getenv("6308685423")
OWNER_USER_NAME = getenv("W_9_9_9")
NEON = getenv("NEON")
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/W_9_9_9",
        caption=f"""[ َِ.𝘀𝗼𝘂𝗿𝗰𝗲  𝗠𝗥 . 𝗫.〙𝘁𝗵𝗲 𝗳 𝗶𝗿𝘀𝘁 𝗰𝗵𝗲𝗿𝘂𝗯 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝗽𝗲𝗼𝗽𝗹𝗲 𝗳𝗼𝗹𝗹𝗼𝘄𝗲𝗱 𝗵 𝗶𝘀 𝗸𝗶𝗻𝗴𝘀 𝗮𝗻𝗱 𝗿𝗮𝗻𝗸 𖥳𝗰𝗿𝗲𝗮𝘁𝗼𝗿𝘀 𝗼𝗳 𝗽𝘂𝘀𝗵𝗰𝗵𝗲𝗻𝗸𝘆♬♪](https://t.me/zzxxue)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩 🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/zzxxue"),
            ]
         ]
     )
  )
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/W_9_9_9",
        caption=f"""[THIS DEV MAIN SOURCE  𝗠𝗥 . 𝗫 ](https://t.me/W_9_9_9)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩 🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/zzxxue"),
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/zzxxue",
        caption=f"""[لـطـلـب ســورس مـيـوزك خـاص بــك او مــيـزه في ســورس مـيـوزك لا تـتـردد فـي الـتـواصـل مـعـي مـن خـلال الـزر فـي الأسـفـل ♬♪](https://t.me/zzxxue)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/zzxxue"),
                InlineKeyboardButton("𓆩👨‍💻︙مطور الـسـورس 𓆪", url=f"https://t.me/W_9_9_9"),
            ]
         ]
     )
  )
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/W_9_9_9",
        caption=f"""[مطور السورس](https://t.me/W_9_9_9)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩👨‍💻︙مطور الـسـورس 𓆪", url=f"https://t.me/W_9_9_9"),
...
def forward(client: Client, message: Message):
  ...
  if message.from_user.id == 6308685423:
    ...
    async for photo in client.iter_profile_photos(message.from_user.id, limit=1):
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " 𝗠𝗥 . 𝗫  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⸥", url=f"https://t.me/zzxxue "),
                ],
            ]
        ),
    )
...
@app.on_message(filters.regex("༺┉⊶﴿♡   𝗠𝗥 . 𝗫  ĶËŸBÖÄŖĐ ♡﴾⊷┉༻") & filters.private & SUDOERS)
async def italy(client: Client, message: Message):
    usr = await client.get_users(message.from_user.id)
    name = usr.first_name
    async for photo in client.iter_profile_photos(message.from_user.id, limit=1):
                    await message.reply_text( 
                    f"""**نبذه سريعه عن**  𝗠𝗥 . 𝗫  ĶËŸBÖÄŖĐ **: **ماهو بيتا كيبورد🤔** **هو اصدار اولي قابل لتعديل في اي وقت قابل الاضافة مميزات واضافة جديد في اي وقت بي اختصار قابل لتحديث ولاضافه في اي وقت**🫡""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
