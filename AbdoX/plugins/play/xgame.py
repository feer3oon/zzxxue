...
GAME_MESSAGE = "⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐑 . 𝐗\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب بودا\n\n⩹━★⊷━⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐑 . 𝐗"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐑 . 𝐗', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐑 . 𝐗', url =f"https://t.me/zzxxue")              
                 ],[
